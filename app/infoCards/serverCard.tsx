  ...
  return (
    <div className="server-card">
      ...
      <p className="text-sm mb-2">
        <strong>Role:</strong> {server.role}
      </p>
      <p className="text-sm mb-2">
        <strong>Email:</strong> {server.email}
      </p>
      <p className="text-sm mb-2">
        <strong>Phone:</strong> {server.phone}
      </p>
      <p className="text-sm mb-3">
        <strong>Wage:</strong> ${server.wage}/hr
      </p>
      <div
        className={`employee-status ${server.isAvailable ? "available" : "unavailable"}`}
      >
